<meta charset="UTF-8">
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
     <link rel="shortcut icon" href="{{ asset('assets/front/img/icon.png') }}" type="image/x-icon">
    <title>{{ $title ?? 'Mê Phim - Xem phim online | Phim mới | Phim hay - vietsub'}}</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/front/css/plyr.css') }}" type="text/css">
