    ...
    (function (global, factory) {
        ...
        var getConstructor = function getConstructor(e) {
            ...
            isEmpty = function isEmpty(e) {
                return (
                    isNullOrUndefined(e) ||
                    ((isString(e) || isArray(e) || isNodeList(e)) &&
                        !e.length) ||
        ...
        function getAttributesFromSelector(sel, existingAttributes) {
            ...
            sel.split(",").forEach(function (s) {
                ...
                var value =
                    parts.length > 1 ? parts[1].replace(/["']/g, "") : ""; // Get the first character
        ...
        function hasClass(element, className) {
            return (
                is$1.element(element) && element.classList.contains(className)
            );
                ...
                [
                    {
                        ...
                        value: function get(key) {
                            ...
                            return is$1.string(key) && key.length
                                ? json[key]
                                : json;
                        },
                    },
        ...
        var controls = {
            ...
            bindMenuItemShortcuts: function bindMenuItemShortcuts(
                menuItem,
                type
            ) {
                var _this2 = this;
            ...
            updateRangeFill: function updateRangeFill(target) {
                ...
                if (matches$1(range, this.config.selectors.inputs.seek)) {
                    ...
                    matches$1(range, this.config.selectors.inputs.volume)
                ) {
            ...
            updateSeekTooltip: function updateSeekTooltip(event) {
                ...
                if (is$1.event(event)) {
                    ...
                    hasClass(this.elements.display.seekTooltip, visible)
                ) {
                    percent = parseFloat(
            ...
            updateSetting: function updateSetting(setting, container, input) {
                ...
                var label = this.elements.settings.buttons[
                    setting
            ...
            setQualityMenu: function setQualityMenu(options) {
                ...
                if (is$1.array(options)) {
                    this.options.quality = dedupe(options).filter(function (
                        quality
                    ) {
                ...
                var toggle =
                    !is$1.empty(this.options.quality) &&
          ...
          emptyElement(list);
           options.forEach(option => {
            ...
            setCaptionsMenu: function setCaptionsMenu() {
                ...
                var options = tracks.map(function (track, value) {
                    return {
                        value: value,
                        checked:
                            _this7.captions.toggled &&
                            _this7.currentTrack === value,
            ...
            showMenuPanel: function showMenuPanel() {
                ...
                var current = Array.from(container.children).find(function (
                    node
                ) {
                    return !node.hidden;
                ...
                dedupe(
                    ...
                    if (control === "progress") {
                        ...
                        var progress = createElement(
                            "div",
                            getAttributesFromSelector(
                                _this10.config.selectors.progress
                            )
                        ); // Seek range slider
                        ...
                        progress.appendChild(
                            createProgress.call(_this10, "buffer")
                    ...
                    if (control === "mute" || control === "volume") {
                        ...
                        if (control === "mute") {
                            volume.appendChild(
                                createButton.call(_this10, "mute")
                            );
                    ...
                    if (
                        ...
                        _this10.config.settings.forEach(function (type) {
                            ...
                            var menuItem = createElement(
                                ...
                                extend(
                                    getAttributesFromSelector(
                                        _this10.config.selectors.buttons
                                            .settings
                                    ),
                                    {
                                        type: "button",
                            ...
                            var backButton = createElement("button", {
                                ...
                                class: ""
                                    .concat(
                                        _this10.config.classNames.control,
                                        " "
                                    )
                                    .concat(
                                        _this10.config.classNames.control,
            ...
            inject: function inject() {
                ...
                if (!is$1.empty(this.elements.buttons)) {
                    var addProperty = function addProperty(button) {
                        var className =
                            _this11.config.classNames.controlPressed;
                ...
                if (this.config.tooltips.controls) {
                    ...
                    Array.from(labels).forEach(function (label) {
                        toggleClass(
                            label,
                            _this11.config.classNames.hidden,
                            false
                        );
                        toggleClass(
                            label,
                            _this11.config.classNames.tooltip,
                            true
                        );
                    });
                }
        ...
        var captions = {
                ...
                return tracks
                    .filter(function (track) {
                        return (
                            !_this3.isHTML5 ||
                            update ||
                            _this3.captions.meta.has(track)
                        );
                    })
                    .filter(function (track) {
            ...
            findTrack: function findTrack(languages) {
                ...
                var sortIsDefault = function sortIsDefault(track) {
                    return Number(
                        (_this4.captions.meta.get(track) || {}).default
                    );
                };
        ...
        var Fullscreen = /*#__PURE__*/ (function () {
            function Fullscreen(player) {
                ...
                this.forceFallback =
                    player.config.fullscreen.fallback === "force"; // Get the fullscreen element
                ...
                on.call(
                    ...
                    function (event) {
                        ...
                        if (
                            ...
                            _this.player.elements.controls.contains(
                                event.target
                            )
                        ) {
                            return;
                        ...
                        value: function update() {
                            if (this.enabled) {
                                ...
                                this.player.debug.log(
                                    "".concat(mode, " fullscreen enabled")
                                );
                            } else {
                                this.player.debug.log(
            ...
            _createClass(Listeners, [
                ...
                },
                {
                    ...
                    value: function setTabFocus(event) {
                        ...
                        var wasKeyDown =
                            event.timeStamp - this.lastKeyDown <= 20; // Ignore focus events if a key was pressed prior
                ...
                },
                {
                    ...
                    value: function container() {
                        ...
                        if (
                            !config.keyboard.global &&
                            config.keyboard.focused
                        ) {
                            on.call(
                                player,
                                elements.container,
                        ...
                        on.call(
                            ...
                            function (event) {
                                var _player$fullscreen = player.fullscreen,
                                    ...
                                    usingNative =
                                        _player$fullscreen.usingNative; // Ignore events not from target
                                ...
                                if (
                                    !player.isEmbed &&
                                    is$1.empty(player.config.ratio)
                                ) {
                                    return;
                                }
                ...
                },
                {
                    ...
                    value: function media() {
                        ...
                        on.call(
                            ...
                            function (event) {
                                return controls.durationUpdate.call(
                                    player,
                                    event
                                );
                            }
                        ...
                        on.call(
                            ...
                            function (event) {
                                return controls.updateProgress.call(
                                    player,
                                    event
                                );
                            }
                        ...
                        on.call(
                            ...
                            "volumechange",
                            function (event) {
                                return controls.updateVolume.call(
                                    player,
                                    event
                                );
                            }
                ...
                },
                {
                    ...
                    value: function controls$1() {
                        ...
                        if (elements.buttons.play) {
                            Array.from(elements.buttons.play).forEach(function (
                                button
                            ) {
                                _this3.bind(
                                    button,
                        ...
                        this.bind(
                            ...
                            function (event) {
                                ...
                                var done = [
                                    ...
                                    "touchend",
                                    "keyup",
                                ].includes(event.type); // If we're done seeking and it was playing, resume playback
                        ...
                        this.bind(
                            ...
                            function (event) {
                                return controls.updateSeekTooltip.call(
                                    player,
                                    event
                                );
                            }
                        ...
                        if (browser.isWebkit) {
                            Array.from(
                                ...
                                _this3.bind(element, "input", function (event) {
                                    return controls.updateRangeFill.call(
                                        player,
                                        event.target
                                    );
                                });
                        ...
                        this.bind(
                            ...
                            function (event) {
                                ...
                                var inverted =
                                    event.webkitDirectionInvertedFromDevice; // Get delta from event. Invert if `inverted` is true

                                var _map = [event.deltaX, -event.deltaY].map(
                                        function (value) {
        ...
        var vimeo = {
            ...
            ready: function ready() {
                ...
                fetch(format(player.config.urls.vimeo.api, id), "json").then(
                    function (response) {
                        ...
                        url.pathname = "".concat(
                            url.pathname.split("_")[0],
                            ".jpg"
                        ); // Set and show poster

                        ui.setPoster
                            .call(player, url.href)
                            .catch(function () {});
                    }
                ); // Setup instance
        ...
        var youtube = {
            ...
            ready: function ready() {
                ...
                if (
                    !is$1.empty(currentId) &&
                    currentId.startsWith("youtube-")
                ) {
                    return;
                } // Get the source URL or ID
                        ...
                        onReady: function onReady(event) {
                            ...
                            player.timers.buffering = setInterval(function () {
                                ...
                                player.media.buffered =
                                    instance.getVideoLoadedFraction(); // Trigger progress only when we actually buffer something
                                ...
                                player.media.lastBuffered =
                                    player.media.buffered; // Bail if we're at 100%
            ...
            _createClass(Ads, [
                    ...
                    value: function requestAds() {
                        ...
                        try {
                            ...
                            request.nonLinearAdSlotHeight =
                                container.offsetHeight; // We only overlay ads as we only support video.
                        ...
                        if (!is$1.empty(this.cuePoints)) {
                            this.cuePoints.forEach(function (cuePoint) {
                                if (
                                    ...
                                    var seekElement =
                                        _this7.player.elements.progress;

                                    if (is$1.element(seekElement)) {
                                        var cuePercentage =
                                            (100 / _this7.player.duration) *
                                            cuePoint;
                                        var cue = createElement("span", {
                                            class: _this7.player.config
                                                .classNames.cues,
                                        });
                                        cue.style.left = "".concat(
                                            cuePercentage.toString(),
                                            "%"
                                        );
                ...
                },
                {
                    ...
                    value: function listeners() {
                        ...
                        this.player.on("seeked", function () {
                            ...
                            _this9.cuePoints.forEach(function (
                                cuePoint,
                                index
                            ) {
                ...
                },
                {
                    ...
                    value: function play() {
                        ...
                        this.managerPromise
                            .then(function () {
                                // Set volume to match player
                                _this10.manager.setVolume(
                                    _this10.player.volume
                    ...
                    value: function loadAds() {
                        ...
                        this.managerPromise
                            .then(function () {
                                ...
                                _this11.managerPromise = new Promise(function (
                                    resolve
                                ) {
                ...
                },
                {
                    ...
                    value: function startSafetyTimer(time, from) {
                        ...
                        this.player.debug.log(
                            "Safety timer invoked from: ".concat(from)
                        );
                ...
                },
                {
                    ...
                    get: function get() {
                        ...
                        return (
                            ...
                            this.player.isVideo &&
                            config.enabled &&
                            (!is$1.empty(config.publisherId) ||
                                is$1.url(config.tagUrl))
                        );
                    },
                },
                {
            ...
            frames.forEach(function (frame) {
                ...
                lines.forEach(function (line) {
                    if (!is$1.number(result.startTime)) {
                        ...
                        !is$1.empty(line.trim()) &&
                        is$1.empty(result.text)
                    ) {
            ...
            _createClass(PreviewThumbnails, [
                ...
                },
                {
                    ...
                    value: function getThumbnails() {
                        ...
                        return new Promise(function (resolve) {
                            var src =
                                _this2.player.config.previewThumbnails.src;
                ...
                },
                {
                    ...
                    value: function render() {
                        ...
                        this.elements.thumb.imageContainer = createElement(
                            "div",
                            {
                                class: this.player.config.classNames
                        ...
                        this.elements.scrubbing.container = createElement(
                            "div",
                            {
                                class: this.player.config.classNames
                ...
                },
                {
                    ...
                    value: function showImageAtCurrentTime() {
                        ...
                        var thumbNum = this.thumbnails[0].frames.findIndex(
                            function (frame) {
                                return (
                            ...
                            function (image) {
                                ...
                                if (
                                    ...
                                    var currentImageContainer =
                                        _this8.currentImageContainer;
                                    setTimeout(function () {
                                        currentImageContainer.removeChild(
                                            image
                                        );
                        ...
                        return new Promise(function (resolve) {
                            setTimeout(function () {
                                ...
                                if (
                                    ...
                                    if (forward) {
                                        thumbnailsClone =
                                            _this9.thumbnails[0].frames.slice(
                                                thumbNum
                                            );
                                    } else {
                                        thumbnailsClone =
                                            _this9.thumbnails[0].frames
                                                .slice(0, thumbNum)
                                                .reverse();
                                    }
                ...
                },
                {
                    ...
                    value: function setImageSizeAndOffset(previewImage, frame) {
                        ...
                        previewImage.style.left = "-".concat(
                            frame.x * multiplier,
                            "px"
                        ); // eslint-disable-next-line no-param-reassign

                        previewImage.style.top = "-".concat(
                            frame.y * multiplier,
                            "px"
                        );
                    },
            ...
            change: function change(input) {
                ...
                this.destroy.call(
                    ...
                    function () {
                        ...
                        if (
                            _this2.isHTML5 ||
                            (_this2.isEmbed && !_this2.supported.ui)
                        ) {
                            // Setup interface
                        ...
                        if (!is$1.empty(input.previewThumbnails)) {
                            ...
                            if (
                                _this2.previewThumbnails &&
                                _this2.previewThumbnails.loaded
                            ) {
            ...
            function Plyr(target, options) {
                ...
                this.config = extend(
                    ...
                    (function () {
                        try {
                            return JSON.parse(
                                _this.media.getAttribute("data-plyr-config")
                            );
                        } catch (e) {
                            return {};
                        }
                ...
                if (
                    is$1.nullOrUndefined(this.media) ||
                    !is$1.element(this.media)
                ) {
                    this.debug.error(
                ...
                [
                    ...
                    },
                    {
                        ...
                        value: function pause() {
                            if (
                                !this.playing ||
                                !is$1.function(this.media.pause)
                            ) {
                                return null;
                            }
                    ...
                    },
                    {
                        ...
                        value: function increaseVolume(step) {
                            ...
                            this.volume =
                                volume + (is$1.number(step) ? step : 0);
                        },
                        /**
                         * Decrease volume
                         * @param {Boolean} step - How much to decrease by (between 0 and 1)
                            ...
                            if (this.supported.ui && !this.isAudio) {
                                ...
                                var force =
                                    typeof toggle === "undefined"
                                        ? undefined
                                        : !toggle; // Apply and get updated state
                    ...
                    },
                    {
                        ...
                        get: function get() {
                            return Boolean(
                                this.paused && this.currentTime === 0
                            );
                        },
                        /**
                         * Get ended state
                 ...
                 default:
                    ...
                    },
                    {
                        ...
                        get: function get() {
                            ...
                            var ratio = reduceAspectRatio(
                                getAspectRatio.call(this)
                            );
                    ...
                    },
                    {
                         ...
                         */
                        get: function get() {
                            return (captions.getCurrentTrack.call(this) || {})
                                .language;
                        },
                        /**
                    ...
                    },
                    {
                        ...
                        set: function set(input) {
                            ...
                            var toggle = is$1.boolean(input)
                                ? input
                                : !this.pip; // Toggle based on current state
                            // Safari
